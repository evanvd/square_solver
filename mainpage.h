 ...
 *
 * @subsection solver_module Модуль решения уравнений (solver.h/solver.c)
 ...
 *
 * @subsection io_module Модуль ввода-вывода (IO.h/IO.c)
 ...
 *
 * @subsection testing_module Модуль тестирования (tests.h/tests.c)
 ...
 *
 * @subsection compilation_subsec Компиляция
 * @subsection running_subsec Запуск
 *
 * @section examples_sec Примеры уравнений
 *
 * <table>
 * <tr><th>Уравнение</th><th>Коэффициенты</th><th>Результат</th></tr>
 * <tr><td>x² - 5x + 6 = 0</td><td>1 -5 6</td><td>x₁ = 3, x₂ = 2</td></tr>
 * <tr><td>2x² - 4x + 2 = 0</td><td>2 -4 2</td><td>x = 1</td></tr>
 * <tr><td>6x² + 2x + 1 = 0</td><td>6 2 1</td><td>Нет решений</td></tr>
 * <tr><td>0x² + 0x + 0 = 0</td><td>0 0 0</td><td>Бесконечно много решений</td></tr>
 * <tr><td>0x² + 0x + 1 = 0</td><td>0 0 1</td><td>Нет решений</td></tr>
 * <tr><td>0x² + x - 1 = 0</td><td>0 1 -1</td><td>x = 1</td></tr>
 * </table>
 *
 ...
 *
 * 1. **Квадратное уравнение с двумя корнями**: x² - 5x + 6 = 0
 * 2. **Квадратное уравнение с одним корнем**: 2x² - 4x + 2 = 0
 * 3. **Квадратное уравнение без корней**: 6x² + 2x + 1 = 0
 * 4. **Вырожденный случай (0=0)**: 0x² + 0x + 0 = 0
 * 5. **Вырожденный случай (1=0)**: 0x² + 0x + 1 = 0
 * 6. **Линейное уравнение**: 0x² + x - 1 = 0
 *
 ...
 * - ❌ Нулевой указатель на структуру результатов
 *
 */
